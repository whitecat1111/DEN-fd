'''在Split Fashion-MNIST数据集上测试不同模型性能'''
import os
import numpy as np
...
# ======================================================
# 1. Split Fashion-MNIST Loader
# ======================================================
class SplitFashionMNISTData(object):
    def __init__(self):
    ...
    def _one_hot(self, y, num_classes=2):
        return np.eye(num_classes)[y]

    def get_task_data(self, task_id, classes_per_task=2):
...
flags.DEFINE_string("dims", "784,312,128,2", "")
...
# ======================================================
# 4. Generate 5 Tasks for Split Fashion-MNIST
# ======================================================
dataset = SplitFashionMNISTData()
num_tasks = 5
